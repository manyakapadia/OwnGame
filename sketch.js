...
var goblet7Found, ringFound, gameState, scene1objects, diaryFound, snakeFound;
...
function scene3(){
  ...
  books = createSprite(1250, 500, 30,30);
  ...
  hammock2 = createSprite(1550, 250, 70,30);
  hammock2.addImage("hammock", hammock2Img);
  hammock2.scale = 0.5;

  hammock3 = createSprite(950, 250, 70,30);
  ...
  cabinet = createSprite(1800, 500, 70,30);
  ...
  chest3 = createSprite(1600, 500, 70,30);
  chest3.addImage("chest", chest2Img);
  chest3.scale = 0.4;
  ...
  locket = createSprite(1850, 550, 70,30);
  locket.addImage("locket", locketImg);
  locket.scale = 0.3;

  diadem = createSprite(550,750, 70,30);
...
function scene1(){
  ...
  lantern3 = createSprite(600, 400, 70,30);
  ...
  vases5 = createSprite(1450, 550, 70,30);
  ...
  vase4 = createSprite(1300, 650, 70,30);
  ...
  goblet7 = createSprite(1400, 650, 70,30);
  goblet7.addImage("goblet7", goblet7Img);
  goblet7.scale = 0.3;

  scene1objects.add(goblet7);
  
  ring = createSprite(190, 650, 70,30);
  ...
  image(goblet7Img, windowWidth/2 + 830, windowHeight/2 + 320, 90, 102);
  image(ringImg, windowWidth/2 + 770, windowHeight/2 + 300, 80, 106);
  //I am unable to click on both the objects
  ...
  if(goblet7Found === true && ringFound === false){
    fill("black");
    rect(50,50, 500,50);
    fill("white");
    textSize(30);
    text("Congratulations! You have successfully found and destroyed the cup! ", 50,50);
  }

  else if(ringFound === true && goblet7Found === false){
    fill("black");
    rect(50,50, 500,50);
    fill("white");
    textSize(30);
    text("Congratulations! You have successfully found and destroyed the ring! You are one step closer to defeating Voldemort", 50,50);
  }

  else if(ringFound === true && goblet7Found === true){
    fill("white");
    textSize(30);
    text("Congratulations! We are moving to the next scene. Find the other objects now.", 50,50);
    scene2();
  ...
  function scene2(){
    ...
    snake = createSprite(1800, 650, 70,30);
    snake.addImage("snake", snakeImg);
    snake.scale = 0.2;

    diary = createSprite(230, 650, 70,30);
    diary.addImage("diary", diaryImg);
    diary.scale = 0.4;
    
    image(snakeImg, windowWidth/2 + 830, windowHeight/2 + 320, 90, 102);
  image(diaryImg, windowWidth/2 + 770, windowHeight/2 + 300, 80, 126);
